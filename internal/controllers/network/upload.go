...
func (r *orcNetworkReconciler) uploadImageContent(ctx context.Context, orcImage *orcv1alpha1.Image, imageClient clients.ImageClient, glanceImage *images.Image) (err error) {
	log := ctrl.LoggerFrom(ctx)
