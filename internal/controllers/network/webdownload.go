...
func (r *orcNetworkReconciler) canWebDownload(ctx context.Context, orcImage *orcv1alpha1.Image, imageClient clients.ImageClient) (bool, error) {
...
func (r *orcNetworkReconciler) webDownload(ctx context.Context, orcImage *orcv1alpha1.Image, imageClient clients.ImageClient, glanceImage *images.Image) error {
	log := ctrl.LoggerFrom(ctx)
