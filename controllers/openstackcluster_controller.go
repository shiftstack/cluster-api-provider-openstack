...
func reconcileDelete(ctx context.Context, scope scope.ClientGeneratorScope, patchHelper *patch.Helper, cluster *clusterv1.Cluster, openStackCluster *infrav1.OpenStackCluster) (ctrl.Result, error) {
...
func deleteBastion(scope scope.ClientGeneratorScope, cluster *clusterv1.Cluster, openStackCluster *infrav1.OpenStackCluster) error {
...
func reconcileNormal(ctx context.Context, scope scope.ClientGeneratorScope, patchHelper *patch.Helper, cluster *clusterv1.Cluster, openStackCluster *infrav1.OpenStackCluster) (ctrl.Result, error) {
...
func reconcileBastion(scope scope.ClientGeneratorScope, cluster *clusterv1.Cluster, openStackCluster *infrav1.OpenStackCluster) error {
...
func reconcileNetworkComponents(scope scope.ClientGeneratorScope, cluster *clusterv1.Cluster, openStackCluster *infrav1.OpenStackCluster) error {
	clusterName := fmt.Sprintf("%s-%s", cluster.Namespace, cluster.Name)
