...
func extractNetwork(network *apiv1alpha1.Network, fieldManager string, subresource string) (*NetworkApplyConfiguration, error) {
	b := &NetworkApplyConfiguration{}
	err := managedfields.ExtractInto(network, internal.Parser().Type("com.github.k-orc.openstack-resource-controller.api.v1alpha1.Network"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
...
func (b *NetworkApplyConfiguration) WithSpec(value *ImageSpecApplyConfiguration) *NetworkApplyConfiguration {
	b.Spec = value
	return b
}
...
func (b *NetworkApplyConfiguration) WithStatus(value *ImageStatusApplyConfiguration) *NetworkApplyConfiguration {
	b.Status = value
	return b
}
