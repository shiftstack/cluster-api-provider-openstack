...
type ImageImport struct {
	// ID contains the UUID of an existing glance image. Note that when
	// specifying an image import by ID, the image MUST already exist. The Image
	// will enter an error state if the image does not exist.
	// +optional
